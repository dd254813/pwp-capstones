...
nonfiction2 = Tome_Rater.create_non_fiction("Computing Machinery and Intelligence", "AI", "advanced", 11111938, 21)
...
Tome_Rater.add_book_to_user(book2, "david@computation.org", 4)
...
#check ISBN unique
# Tome_Rater.check_isbn_unique()
# #MOST  N  READ BOOKS
#print(Tome_Rater.get_n_most_read_books(1))
#print(Tome_Rater.get_n_most_prolific_readers(2))
# print(Tome_Rater.get_n_most_expensive_books(26))
# print(Tome_Rater.get_worth_of_user('alan@turing.com'))
# print(Tome_Rater.recommend_to_buy_most_read_books('david@computation.org', 1))
# print(Tome_Rater)
